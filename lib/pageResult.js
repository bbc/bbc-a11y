...
PageResult.prototype.test = function (standard, jquery, pageConfiguration, ask) {
  if (typeof standard.manualTest == 'object') {
    return ask(standard.manualTest.question)
      .catch(notes => standardResult.addError(notes))
  }
  ...
  return allFrameTests.reduce(function (promise, frameTest) {
    return promise.then(function() {
      var testResult = standard.test(frameTest.find, frameTest.fail, frameTest.warn, pageConfiguration, ask)
