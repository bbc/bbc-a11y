...
Standards.prototype.validate = function(jquery) {
  var validationResult = new ValidationResult(this.skipped, this.hide)
  var standardResult;
  function fail() {
  ...
  for (var i = 0; i < this.standards.length; ++i) {
    ...
    standardResult = validationResult.createStandardResult(this.standards[i].section, this.standards[i].name);
