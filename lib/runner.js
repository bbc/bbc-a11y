...
function askInFrame (question) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    var passButton = jquery('<button class="pass-button">Yes</button>').appendTo(commentsArea)
    passButton.on('click', function () {
      resolve()
    })
    var failButton = jquery('<button class="fail-button">No</button>').appendTo(commentsArea)
