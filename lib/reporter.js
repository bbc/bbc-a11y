...
Reporter.prototype.runStarted = function() {
  this.summary =  { pagesChecked: 0, errorsFound: 0, standardsSkipped: 0 }
}

Reporter.prototype.pageChecked = function(url, validationResult) {
  this.summary.pagesChecked++
  this.summary.standardsSkipped = validationResult.skipped.length
}

Reporter.prototype.pagePassed = function(url, validationResult) {
  var statusLine = '✓ ' + url
  this.devToolsConsole.log(statusLine)
  this.commandLineConsole.log(statusLine)
}

Reporter.prototype.pageFailed = function(url, validationResult) {
  var statusLine = '✗ ' + url
  this.devToolsConsole.log(statusLine)
  this.commandLineConsole.log(statusLine)
